...
user_repository.save(User(id="user-3", name="Iker", password="iker1234",avatar="https://yt3.ggpht.com/ytc/AKedOLT4UiE45nkLTf45Q8Dud9I-w1hiVQXPgmKPz7pE=s900-c-k-c0x00ffffff-no-rj",email="ikersanchez.contacto@gmail.com",phone="691755353",bio="Soy Iker Sánchez de Bilbao y soy el dueño y administrador de la aplicación",level="999",experiencie="99999"))
log_repository = LogsRepository(database_path)
log_repository.save(Log(log_id=44, id='user-1', dinero_ofrecido=27.33,
                    dinero_entregado=29.12, hora=22.31, completado=False,mes="Enero",juego="Poker"))
log_repository.save(Log(log_id=52, id='user-1', dinero_ofrecido=14.03,
                    dinero_entregado=10.12, hora=15.35, completado=False,mes="Enero",juego="Juego 1"))
